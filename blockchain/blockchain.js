...
class Transaction {
   ...
   */
  calculateHash() {
    return crypto.createHash('sha256').update(this.voter + this.candidate + this.amount + this.timestamp).digest('hex');
  }
...
class Blockchain {
  ...
  addTransaction(transaction) {
    ...
    if (this.getBalanceOfAddress(transaction.voter) < transaction.amount) {
